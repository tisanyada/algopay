                    ...
                    <div className="d-flex justify-content-between w-100" id="navbarSupportedContent">
                        ...
                        <ul className="navbar-nav align-items-right">
                            <li className="nav-item dropdown">
                                <Link className="nav-link text-dark notification-bell dropdown-toggle" data-unread-notifications="true" to="#" role="button" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
