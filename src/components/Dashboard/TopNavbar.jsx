                        ...
                        <div className="d-flex align-items-center">
                            <button className="btn btn-gray-800 d-inline-flex align-items-center me-2 dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span className="sidebar-icon">
                                    <img src={process.env.PUBLIC_URL + "/assets/img/brand/light.svg"} height="20" width="20" alt="Volt Logo" />
                                </span>
                                <span className="mt-1 ms-1 sidebar-text">Algo Pay</span>
                            </button>
                        </div>
                        <ul className="navbar-nav align-items-right">
                            <li className="nav-item dropdown">
                                <Link className="nav-link text-dark notification-bell unread dropdown-toggle" data-unread-notifications="true" to="#" role="button" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                                ...
                                <Link className="nav-link dropdown-toggle pt-1 px-0" to="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div className="media d-flex align-items-center">
                                        <img
                                            ...
                                            src={studentprofile ? studentprofile.passport : "/assets/img/team/profile-picture-3.jpg"}
                                        />
                                        <div className="media-body ms-2 text-dark align-items-center d-none d-lg-block">
                                            <span className="mb-0 font-small fw-bold text-gray-900">{student ? student.schoolMail : null}</span>
                                        </div>
                                    </div>
                                </Link>
